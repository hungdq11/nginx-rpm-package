...
%define luajit_inc /usr/include/luajit-2.0
%define luajit_lib /usr/lib64
%define lib_module /usr/lib64/nginx/modules
...
%define BASE_CONFIGURE_ARGS $(echo "--prefix=%{_sysconfdir}/nginx --sbin-path=%{_sbindir}/nginx --modules-path=%{_libdir}/nginx/modules --conf-path=%{_sysconfdir}/nginx/nginx.conf --error-log-path=%{_localstatedir}/log/nginx/error.log --http-log-path=%{_localstatedir}/log/nginx/access.log --pid-path=%{_localstatedir}/run/nginx.pid --lock-path=%{_localstatedir}/run/nginx.lock --http-client-body-temp-path=%{_localstatedir}/cache/nginx/client_temp --http-proxy-temp-path=%{_localstatedir}/cache/nginx/proxy_temp --http-fastcgi-temp-path=%{_localstatedir}/cache/nginx/fastcgi_temp --http-uwsgi-temp-path=%{_localstatedir}/cache/nginx/uwsgi_temp --http-scgi-temp-path=%{_localstatedir}/cache/nginx/scgi_temp --user=%{nginx_user} --group=%{nginx_group} --with-file-aio --with-threads --with-ipv6 --with-http_addition_module --with-http_auth_request_module --with-http_dav_module --with-http_flv_module --with-http_gunzip_module --with-http_gzip_static_module --with-http_mp4_module --with-http_random_index_module --with-http_realip_module --with-http_secure_link_module --with-http_slice_module --with-http_ssl_module --with-openssl=openssl-1.0.2l  --with-http_stub_status_module --with-http_sub_module --with-http_v2_module --with-mail --with-mail_ssl_module --with-stream --with-stream_ssl_module --with-http_xslt_module=dynamic --with-http_image_filter_module=dynamic  --with-http_geoip_module=dynamic --add-module=ngx_devel_kit-master --add-dynamic-module=lua-nginx-module-master --add-dynamic-module=echo-nginx-module-master --add-dynamic-module=headers-more-nginx-module-master --add-dynamic-module=set-misc-nginx-module-master --add-dynamic-module=nginx-rtmp-module-master --add-dynamic-module=nginx-push-stream-module-master")
...
Source12: COPYRIGHT
Source13: openssl-1.0.2l.tar.gz
Source14: ngx_devel_kit-master.tar.gz
Source15: lua-nginx-module-master.tar.gz
Source16: echo-nginx-module-master.tar.gz
Source17: headers-more-nginx-module-master.tar.gz
Source18: set-misc-nginx-module-master.tar.gz
Source19: nginx-rtmp-module-master.tar.gz
Source20: nginx-push-stream-module-master.tar.gz
